...
//  Hello
//
//  Created by CharlieDavid on 6/9/21.
//

import SwiftUI

struct TextRelated: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 100.0) {
            //1.Text
            Text("Text:仅显示文本,不支持输入\(textEditorInput)")
                .lineLimit(1)
            ...
            //5.Link
            Link("Link:点击并跳转链接", destination: URL(string: "https://www.swiftmo.gitbook.com")!)
